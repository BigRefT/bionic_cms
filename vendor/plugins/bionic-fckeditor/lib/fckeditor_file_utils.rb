...
module FckeditorFileUtils
  ...
  PLUGIN_INSTALL_DIRECTORY =  File.join(RAILS_ROOT, '/vendor/plugins/bionic-fckeditor/')
  ...
  def FckeditorFileUtils.copy_configuration
    ...
    config_file = File.join(RAILS_ROOT, '/vendor/plugins/bionic-fckeditor/public/javascripts/fckcustom.js')
  ...
  def FckeditorFileUtils.install(log)
    directory = File.join(RAILS_ROOT, '/vendor/plugins/bionic-fckeditor/')
